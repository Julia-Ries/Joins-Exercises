...
joins_exercise=# SELECT * FROM owners FULL OUTER JOIN vehicles on owners.id = vehicles.owner_id;
...
joins_exercise=# SELECT first_name, last_name, COUNT(owner_id) FROM owners o
...
SELECT first_name, last_name, COUNT(owner_id), ROUND(AVG(price)) AS average_price FROM owners o
